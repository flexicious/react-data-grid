...
export default class ExportOptionsView extends UIComponent {
     ...
     */
    render() {
        return <div style={{ height: "400px", width: "800px" }}>
            ...
            <div className={"options flexiciousGrid"} style={{ float: "right", textAlign: "left", padding: "20px" }}>
                <div style={this.enablePaging ? {} : { pointerEvents: "none", opacity: 0.4 }}>
