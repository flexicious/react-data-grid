    ...
    return (
      <div>
        ...
        <FullWidthSection useContent={true}>
          ...
          <RaisedButton onTouchTap={() => { this.refs.grid.clearSelection() } } label={"Clear Selection"} />
          <RaisedButton onTouchTap={() => { alert('Selected Keys:' + this.refs.grid.getSelectedKeys().join('|')) } } label={"Show Selection"} />
