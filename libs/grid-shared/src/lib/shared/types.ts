...
export const makeStringColumn = (fld: string): ColumnOptions => ({
  ...
  editOptions: distinctValueColumns.includes(fld) ? createSelectEditorOptions(): {
    ...createTextInputEditorOptions(),
    editStartMode: EditStartMode.DoubleClick,
  },
...
export const makeNumberColumn = (fld: string): ColumnOptions => ({
  ...
  editOptions: createTextInputEditorOptions(),
