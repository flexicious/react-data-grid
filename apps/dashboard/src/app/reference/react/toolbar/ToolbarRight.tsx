    ...
    return <div className="ezgrid-dg-toolbar-section">
        ...
        {options?.enableGlobalSearch !== false && hasFilterBehavior
            && createTextField(node.gridOptions, {
                type: "text", placeholder: "Filter...", onKeyDown: debouncedGlobalFilterChange, ref: textInputGlobalSearch, 
                style: { width: textBoxWidth }
            })}
        {options?.enableQuickFind !== false && createTextField(node.gridOptions, {
            type: "text", placeholder: "Find...", onKeyDown: handleOnFindKeyDown, ref: textInputFind, 
            style: { width: textBoxWidth }
        })}
        {quickFind && (
